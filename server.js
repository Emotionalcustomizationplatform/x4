...
const JWT_SECRET = process.env.JWT_SECRET || 'change-this-to-random-string';
...
app.post('/api/submit', async (req, res) => {
    ...
    const logFile = path.join(logPath, `leads_${dateStr}.jsonl`);
...
app.listen(port, '0.0.0.0', () => console.log(`🌙 Luna Whisper 运行在 http://localhost:${port}`));